		...
		<footer className="bg-[#3d2817] text-white py-12">
			<div className="container mx-auto px-4">
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
					<div>
						<div className="mb-4">
							<h3 className="text-xl font-bold mb-2">HZD Logo</h3>
						</div>
					...
					<div>
						...
						<div className="space-y-4">
							<div className="bg-yellow-400/20 p-4 rounded">
								<p className="text-sm">SH 2023</p>
							</div>
							<div className="text-sm">FCI Logo</div>
							<div className="text-sm">VDH Logo</div>
						</div>
					</div>
				</div>
				<div className="border-t border-[#5a3d2a] pt-4 text-center text-sm text-gray-300">
					<p>Werbedesign. © 2023 Werbeagentur LAWRENZ Die Qualiäter</p>
				</div>
			</div>
		</footer>
	)
